...
select to_char("month", 'MM-DD-YYYY') as date, mau, retained, new, resurrected, churned from mau_growth_accounting where month < '2023-04-01' order by month asc;

-- -- For MRR growth accuonting use this
-- select to_char("month", 'MM-DD-YYYY') as date, rev, retained, contraction, resurrected, new, churned, expansion from mrr_growth_accounting where month < '2023-03-01';
